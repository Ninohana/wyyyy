...
function encryptedString(a, b) {
    // 声明一个数组c，将b（secretKey）字符串转为对应ASCII码数组
    ...
    for (f = c.length, g = "", e = 0; f > e; e += a.chunkSize) {
        // 将c数组数据每两位合并到j数组中去，规则为前一个加上后一个左移8位（即乘以256）
...
function aes(message, secretKey) {
    var c = CryptoJS.enc.Utf8.parse(secretKey)
        , d = CryptoJS.enc.Utf8.parse("0102030405060708")
        , e = CryptoJS.enc.Utf8.parse(message)
...
function encryptString(secretKey, b, c) {
    var d, e;
    setMaxDigits(131);
    d = new RSAKeyPair(b, "", c);
    e = encryptedString(d, secretKey);
    return e;
}
function d(d, e, f, g) {
    var h = {}, secretKey = randomAlphanumeric(16);
    h.encText = aes(d, g);
    h.encText = aes(h.encText, secretKey);
    h.encSecKey = encryptString(secretKey, e, f);
    return h;
}
function e(a, b, d, e) {
    var f = {};
    return f.encText = encryptString(a + e, b, d),
        f
}

/*
var bsF5K = function(cxM0x) {
    var c7f = window.NEJ.P;
    j7c = c7f("nej.u");
    St9k = c7f("nm.x.ek");
    var m7f = [];
    j7c.bg8Y(cxM0x, function(cxL0x) {
        m7f.push(St9k.emj[cxL0x])
    });
    return m7f.join("")
};
*/
// var bVc6W = window.asrsea(JSON.stringify(i7b), bsF5K(["流泪", "强"]), bsF5K(St9k.md), bsF5K(["爱心", "女孩", "惊恐", "大笑"]));
function asrsea(data){
    var ep = '010001',
    fp = '',
    gp = '0CoJUm6Qyw8W8jud';
    return d(JSON.stringify(data), ep, fp, gp);
}
// "{"userId":"44786608","total":"false","limit":"20","time":"1595349071746","getcounts":"true","csrf_token":""}"
